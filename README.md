# Disentangling linguistic features effects in TMNRED EEG dataset: a mixed models re-analysis
This repository contains the code and analyses for the study "Disentangling linguistic features effects in TMNRED EEG dataset: a mixed models re-analysis", which investigated the relationships between EEG features, linguistic features and semantic processing. 
